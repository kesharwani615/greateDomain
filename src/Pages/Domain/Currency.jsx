...
import { currency_CreateSlice, currency_DeleteSlice, currency_EditSlice, currencySlice } from '../../redux/features/currency';
...
const Currency = () => {
  ...
  const [Currency_Edit,setCurrencyEdit] = useState();

  const [editItemId,setEditItemId] = useState();

  const { currency_Data,loading,currency_delete } = useSelector((state)=>state.currency);
  ...
  useEffect(()=>{
    ...
    currency_Data?.forEach((item)=>{
    const {currency_id:Id,currency_name:Name} = item;
  ...
  const deleteItem = (id) =>{
    ...
    dispatch(currency_DeleteSlice(id))
  }

  useEffect(()=>{
    console.log("Currency_delete:",currency_delete);
  ...
  const createCurrency = () =>{
    ...
    dispatch(currency_CreateSlice(Currency_name));
    setOpen(!open)
    setCurrencyName('')
  }
  ...
  const EditItem = (itemId) =>{
   ...
   setCurrencyEdit(filteredItem.Name);
  }
  ...
  const EditCurrency = () =>{
    ...
    console.log(Currency_Edit);
    dispatch(currency_EditSlice({editItemId,Currency_Edit}));
    setEditOpen(!Editopen)
    setCurrencyName('')
  }
  ...
  return (
    ...
    <span className='text-black bg-white text-[40px] px-10'>Currency</span>

    <div className=" px-8 text-black pt-10 pb-14 ">
    <div className="w-full p-4 rounded-md bg-white">
      <div>
        <h1 className="text-2xl font-medium text-[#212B36]">Currency list</h1>
      </div>
  ...
  <table className="w-full table-auto border border-collapse table-fixed">
    <thead className="rounded-lg text-base text-white font-semibold w-full">
      <tr className="border-x-2 border-t-2 border-b-2">
    ...
    {/*Add Currency form*/}
      ...
      >
        <div className="w-[500px] bg-white rounded-lg shadow-lg p-6">
          <div className="border-b pb-3">
            <h3 className="text-lg text-black font-medium">Create Currency</h3>
          </div>
          <div className="py-4">
          <div className="w-72">
      ...
      >
        <div className="w-[500px] bg-white rounded-lg shadow-lg p-6">
          <div className="border-b pb-3">
            <h3 className="text-lg text-black font-medium">Edit Currency</h3>
          </div>
          <div className="py-4">
          <div className="w-72">
      <div className="relative">
